...
class NotificationService {
  ...
  async setupNotifications(
    ...
    // Note: Background message handler is now registered in index.js
    // This MUST be done at the top level, not inside a function

    // Handle notification action press (this is still needed for foreground actions)
